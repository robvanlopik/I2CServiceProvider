...
//
// Nodified by Rob van Lopik
// 
// remove hardware acces and replace with access through I2CServer
// We rename the class Bus to XBus 
import gpio
import serial
import .api show *
...
class XBus:
  ...
  /**
  Open the ServiceClient
  */
  constructor .i2c_/I2CServiceClient:
    i2c_.open
  /**
  ...
  */
  ...
  Releases the resources associated with this Xbus.
  */
  close -> none:
  ...
  */
  ...
  write_ i2c_address/int bytes/ByteArray :
    i2c_.write i2c_address bytes
  /*  r :=  i2c_.write i2c_address bytes
...
*/
  ...
  write_reg_ i2c_address/int register/int bytes/ByteArray [failure]:
    r := i2c_.write_reg i2c_address register bytes
    if r: return failure.call "I2C_WRITE_FAILED"
    return r
*/
/* not neeed ??
...
*/
  ...
  read_ i2c_address/int size/int [failure] -> ByteArray:
    return i2c_.read i2c_address size
...
*/
 ...
 /* replaced
  ...
  read_reg register/int size/int -> ByteArray:
    return i2c_.read_ address register size
...
class Registers extends serial.Registers:
  ...
  */
  ...
  write_bytes reg bytes:
    ...
    device_.write data
/* the following are primitives and not needed
